                        ...
                        builder: (context, invoice, _) => Column(
                          children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: Text(
                                              "${MyHomePage.numberFormat.format(int.parse(invoice.item.last['price']))} ریال",
                                              style: const TextStyle(
                                                fontSize: 16,
                                              ),
                                            ),
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                setState(() {
                                  _isLoadingSubmitFactor = true;
                                });
                                await Provider.of<Invoice>(context,
                                        listen: false)
                                    .setDoneOrderInvoice(
                                        dashboard.order['id'], context)
                                    .then(
                                  (result) {
