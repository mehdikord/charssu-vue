...
class DoneOrdersScreen extends StatefulWidget {
  const DoneOrdersScreen({Key? key}) : super(key: key);

  static const routeName = "/orders/done";

  @override
  State<DoneOrdersScreen> createState() => DoneOrdersScreenState();
}

class DoneOrdersScreenState extends State<DoneOrdersScreen> {
  late Future _dashboardDoneOrdersFuture;

  Future _obtainDashboardDoneOrdersFuture() {
    return Provider.of<Dashboard>(context, listen: false)
        .fetchAndSetDashboardDoneOrders();
  }

  @override
  void initState() {
    _dashboardDoneOrdersFuture = _obtainDashboardDoneOrdersFuture();
    super.initState();
  }
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  const Divider(),
                                  FutureBuilder(
                                    future: _dashboardDoneOrdersFuture,
